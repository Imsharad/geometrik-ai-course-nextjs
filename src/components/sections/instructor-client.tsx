...
// Define the instructor data structure that will be passed as props
...
export function InstructorClient({ instructor }: InstructorClientProps) {
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-10">
            ...
            <motion.div variants={itemVariants}>
              ...
              <p className="text-sm text-gray-600 mt-1">{instructor.location}</p>
            </motion.div>
